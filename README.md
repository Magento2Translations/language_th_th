...
# Version & progress
This translation is generated from the branch [Head](https://crowdin.com/project/magento-2/th#/Head) at Crowdin and based on the Magento 2.3.1 sourcefiles.
There have been  533 strings translated of the 11254 strings in the Magento source.
...
composer require magento2translations/language_th_th:dev-master
php bin/magento cache:clean
```
## Manually
To install this language package manually you need access to your server file system.
* Download the zip file [here](https://github.com/Magento2Translations/language_th_th/archive/master.zip).
